...
@pytest.mark.parametrize("dotbracket_structures,start_position,end_position,"
                         "left_or_right,how_many,how_many_nt_by_structure,"
                         "adjusted", [
...
def test_move_structures(
        ...
        how_many, how_many_nt_by_structure,
        adjusted):
...
@pytest.mark.parametrize(
    "dotbracket_structures,position,unusual_positions_places,representations,"
    "should_be", [
    ...
    (['.((((--------........))))........((((....)))).......-..',
     ...
     1,
     [1, 2, 3, 4],
     [{1: 24, 2: 23, 3: 22, 4: 21, 21: 4, 22: 3, 23: 2, 24: 1, 33: 44, 34: 43,
       35: 42, 36: 41, 41: 36, 42: 35, 43: 34, 44: 33},
      {1: 53, 2: 52, 3: 51, 4: 50, 5: 49, 6: 48, 10: 23, 11: 22, 12: 21,
       21: 12, 22: 11, 23: 10, 33: 44, 34: 43, 35: 42, 36: 41, 41: 36, 42: 35,
       43: 34, 44: 33, 48: 6, 49: 5, 50: 4, 51: 3, 52: 2, 53: 1}],
     (21, 24)
     ),
    ...
    (['.((((--------........))))........((((....)))).......-..',
     ...
     1,
     [1, 2, 3, 4, 5],
     [{1: 24, 2: 23, 3: 22, 4: 21, 21: 4, 22: 3, 23: 2, 24: 1, 33: 44,
       34: 43,
       35: 42, 36: 41, 41: 36, 42: 35, 43: 34, 44: 33},
      {1: 53, 2: 52, 3: 51, 4: 50, 5: 49, 6: 48, 10: 23, 11: 22, 12: 21,
       21: 12, 22: 11, 23: 10, 33: 44, 34: 43, 35: 42, 36: 41, 41: 36,
       42: 35,
       43: 34, 44: 33, 48: 6, 49: 5, 50: 4, 51: 3, 52: 2, 53: 1}],
     (21, 24)
     ),
...
def test_find_counter_start_end(
        dotbracket_structures, position, unusual_positions_places,
        representations, should_be):
    result = find_counter_start_end(
        dotbracket_structures, position, unusual_positions_places,
        representations)
    assert result == should_be
